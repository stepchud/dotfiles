...
if &t_Co < 88
    hi CSVColumnHeaderOdd ctermfg=white ctermbg=black guibg=grey80 guifg=black
    \ cterm=underline gui=bold,underline
    hi CSVColumnOdd  ctermfg=white ctermbg=black guibg=grey80 guifg=black 
else
    hi CSVColumnHeaderOdd ctermfg=white ctermbg=black guibg=grey80 guifg=black
    \ cterm=underline gui=bold,underline
    hi CSVColumnOdd  ctermfg=white ctermbg=black guibg=grey80 guifg=black 
...
hi CSVColumnEven ctermfg=red ctermbg=black guibg=grey50 guifg=black
hi CSVColumnHeaderEven ctermfg=black ctermbg=red guibg=grey50 guifg=black
\ cterm=underline gui=bold,underline
